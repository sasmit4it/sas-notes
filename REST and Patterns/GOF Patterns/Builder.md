...
To allow creation of complex product in small steps, allowing client to create different representations by altering these steps.

# More Details:

- Creation logic is encapsulated in builder. Achieves Single responsibility.
    
- builder exposes steps used to product construction.
